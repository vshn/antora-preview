FROM ghcr.io/vshn/antora:3.1.14
...
RUN set -x && \
    ...
    curl --silent --location https://github.com/vshn/antora-ui-default/releases/download/v2.7.0/ui-bundle.zip -o /preview/bundles/vshn.zip && \
    curl --silent --location https://github.com/k8up-io/antora-ui-default/releases/download/1.5.0/ui-bundle.zip -o /preview/bundles/k8up.zip && \
