...
RUN curl --silent --location https://github.com/projectsyn/antora-ui-default/releases/download/2.0.0/ui-bundle.zip -o /preview/bundles/syn.zip
...
RUN curl --silent --location https://github.com/vshn/antora-ui-default/releases/download/2.0.5/ui-bundle.zip -o /preview/bundles/vshn.zip
